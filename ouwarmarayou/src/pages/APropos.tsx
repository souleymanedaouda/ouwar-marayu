  ...
  <>
    ...
    <section className="relative gradient-primary text-primary-foreground py-24 md:py-32 overflow-hidden">
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        ...
        >
          À propos d'Ouwar Marayu
        </motion.h1>
        <motion.p
          initial="hidden" animate="visible" variants={fadeUp} custom={2}
          className="text-primary-foreground/80 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed"
        >
          Une organisation humanitaire nigérienne au service des enfants et des familles vulnérables.
        </motion.p>
      </div>
    </section>
    ...
    <section className="section-padding bg-background overflow-hidden">
      <div className="container mx-auto grid lg:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <motion.h2 variants={fadeUp} custom={1} className="section-title !mb-6">Notre Mission</motion.h2>
          ...
          <motion.p variants={fadeUp} custom={3} className="text-muted-foreground leading-relaxed mb-4 text-lg">
            Ouwar Marayu est une organisation humanitaire basée à Niamey, Niger, engagée dans l'aide aux orphelins,
            aux enfants vulnérables, aux veuves et aux familles en situation précaire.
          </motion.p>
          <motion.p variants={fadeUp} custom={4} className="text-muted-foreground leading-relaxed mb-4">
            Notre mission est de redonner espoir et dignité à ceux qui en ont le plus besoin, à travers des actions
            concrètes sur le terrain : distribution de vivres, soutien scolaire, autonomisation économique et
            accompagnement social.
          </motion.p>
          <motion.p variants={fadeUp} custom={5} className="text-muted-foreground leading-relaxed">
            Notre vision est de bâtir un Niger où chaque enfant a accès à l'éducation, à la nourriture et à
            un environnement protecteur, quel que soit son parcours de vie.
          </motion.p>
        </motion.div>
        <motion.div
          initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }}
        ...
        >
          <div className="relative z-10">
            <img
              src={founderPortrait}
              alt="Mme Maïmouna Modi Abdoulaye"
    ...
    <section className="section-padding bg-surface overflow-hidden">
      <div className="container mx-auto grid lg:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <motion.h2 variants={fadeUp} custom={1} className="section-title !mb-6">La Fondatrice</motion.h2>
          <motion.div variants={fadeUp} custom={2} className="w-20 h-1 bg-primary rounded-full mb-8" />
          <motion.h3 variants={fadeUp} custom={3} className="font-heading text-2xl font-semibold text-primary mb-4">
            Mme Maïmouna Modi Abdoulaye
          </motion.h3>
          <motion.p variants={fadeUp} custom={4} className="text-muted-foreground leading-relaxed mb-4">
            Figure engagée et active sur le terrain, Mme Maïmouna Modi Abdoulaye est reconnue pour son
            dévouement envers les enfants et les familles vulnérables du Niger.
          </motion.p>
          <motion.p variants={fadeUp} custom={5} className="text-muted-foreground leading-relaxed mb-4">
            Son parcours est animé par une conviction profonde : chaque enfant orphelin mérite la chance
            de retrouver l'espoir. C'est cette vision qui l'a poussée à fonder Ouwar Marayu et à
            consacrer sa vie à cette cause.
          </motion.p>
          <motion.p variants={fadeUp} custom={6} className="text-muted-foreground leading-relaxed">
            Présente au quotidien sur le terrain, elle supervise personnellement les distributions, les
            campagnes de sensibilisation et les programmes de scolarisation mis en place par l'organisation.
          </motion.p>
        </motion.div>
      </div>
    </section>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mt-12">
          {values.map((v, i) => (
            <motion.div
              ...
              variants={scaleIn}
              custom={i}
              className="group bg-card rounded-2xl p-8 border border-border hover:border-primary/30 hover:shadow-xl transition-all duration-300 text-center"
            >
              <div className="w-16 h-16 rounded-2xl bg-accent flex items-center justify-center mx-auto mb-5 group-hover:bg-primary/15 transition-colors">
